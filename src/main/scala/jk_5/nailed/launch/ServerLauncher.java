...
public class ServerLauncher {
    ...
    public static void main(String[] args) {
        ...
        try{
            launchwrapper = Class.forName("net.minecraft.launchwrapper.Launch", true, ServerLauncher.class.getClassLoader());
        }catch(Exception e){
            System.err.printf("We appear to be missing one or more essential library files.\n" +
                    "You will need to add them to your server before Nailed will run successfully.");
        ...
        try{
            ...
            allArgs[1] = "jk_5.nailed.launch.NailedTweaker";
