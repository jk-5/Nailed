package jk_5.nailed.buildscript.sourcemanip;
        ...
        for (String line : lines) {
            ...
            if (insideMethod) {
                ...
                if (!Strings.isNullOrEmpty(method)) {
                    NailedCleanup namer = new NailedCleanup();
                    ...
                    List<String> sortedKeys = new ArrayList(todo.keySet());
